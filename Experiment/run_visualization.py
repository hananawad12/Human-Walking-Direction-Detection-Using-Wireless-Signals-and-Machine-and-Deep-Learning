...
class UDPListener:
    ...
    def on_datagram_received(self):
        ...
        print('packet_num: ',self.packet_counter)
    ...
    def get_csi_raw_data(self, csi_inf):
        ...
        #num_of_antenna_pairs = 3 * csi_inf.nr
    ...
    def save_csi_to_file(self, raw_peak_amplitudes, raw_phases, carriers):
        ...
        #print('amplitude for antenna 0,0: ',raw_peak_amplitudes[0])
        #print('amplitude for antenna 0,1: ',raw_peak_amplitudes[1])
        #print('amplitude for antenna 1,0: ',raw_peak_amplitudes[2])
        #print('amplitude for antenna 1,1: ',raw_peak_amplitudes[3])
        #print('phase for antenna 0,0: ',raw_phases[0])
        #print('phase for antenna 0,1: ',raw_phases[1])
        #print('phase for antenna 1,0: ',raw_phases[2])
        #print('phase for antenna 1,1: ',raw_phases[3])
...
def run_app() -> None:
    ...
    try:
        ...
        listener = UDPListener(save_data_path=args.save_path, sock=udp_socket,form=form,make_photo=args.photo)
        app.exec()
